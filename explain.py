...
baseline_term_neonate = {
    ...
    "model_groups": {
        ...
        "syst_ven_resistors": ["LS_VLB", "KID_VLB", "INT_VLB", "RLB_VLB", "VLB_IVCI", "BR_VUB", "RUB_VUB", "VUB_SVC", "UMB_VEN", "IVCI_RA", "SVC_RA"],
        ...
        "pericardium": ["PC"],
        "ductus_arteriosus": ["DA"],
        "ductus_art_resistors": ["DA_OUT"],
