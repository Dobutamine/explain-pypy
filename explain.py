...
The code is therefore designed for readability and not optimized for performance at all.
...
Go to https://github.com/Dobutamine/explain-cv for the github repository of this version of explain. 
Additional resources like installation instructions, documentation and example jupyter notebooks are also 
...
import math, random                                     # general modules used by most objects  
...
class Scaler():
    def __init__(self, model_ref: object) -> None:
        ...
        self.res_syst_art_resistors_factor: float = 1.0
        self.res_syst_ven_resistors_factor: float = 1.0
        self.res_pulm_art_resistors_factor: float = 1.0
        self.res_pulm_ven_resistors_factor: float = 1.0
    ...
    def scale_syst_art_resistors(self):
        ...
        for m in self._model_engine.model_groups["syst_art_resistors"]:
            m.r_scaling_factor = (1.0 / self.global_scale_factor) * self.res_syst_art_resistors_factor

    def scale_syst_ven_resistors(self):
        # set the scale factors
        for m in self._model_engine.model_groups["syst_ven_resistors"]:
            m.r_scaling_factor = (1.0 / self.global_scale_factor) * self.res_syst_ven_resistors_factor
    ...
    def scale_pulm_art_resistors(self):
        ...
        for m in self._model_engine.model_groups["pulm_art_resistors"]:
            m.r_scaling_factor = (1.0 / self.global_scale_factor) * self.res_pulm_art_resistors_factor

    def scale_pulm_ven_resistors(self):
        # set the scale factors
        for m in self._model_engine.model_groups["pulm_ven_resistors"]:
            m.r_scaling_factor = (1.0 / self.global_scale_factor) * self.res_pulm_ven_resistors_factor
    ...
    # scale lungs, thorax and chestwall
...
#----------------------------------------------------------------------------------------------------------------------------
# these objects contain all the properties of the different models of the explain model and represent different patients
baseline_term_neonate = {
    "name": "baseline_term",
    "description": "normal 3.545 kg neonate at an age of 24h without shunts",
    "weight": 3.545,
    "height": 0.50,
    ...
    "models": {
        ...
        "COR": {
            "name": "COR",
            "description": "timevarying elastance model of the coronaries",
            "model_type": "BloodTimeVaryingElastance",
            "is_enabled": True,
            "vol": 0.000621944736430777,
            "u_vol": 0.00028,
            "el_min": 30000,
            "el_max": 90000,
            "el_k": 0,
        ...
        "LL": {
            "name": "LL",
            "description": "capacitance model of the blood compartment of the left lung",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.005898417962291056,
            "u_vol": 0.0012431702152874951,
            "el_base": 4380,
            "el_k": 0,
        },
        "RL": {
            "name": "RL",
            "description": "capacitance model of the blood compartment of the right lung",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.005898417962291056,
            "u_vol": 0.0012431702152874951,
        ...
        "PV": {
            "name": "PV",
            "description": "capacitance model of the pulmonary veins",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.007770162715477027,
            "u_vol": 0.00563081048728314,
            "el_base": 4517,
            "el_k": 0,
        },
        "PA": {
            "name": "PA",
            "description": "capacitance model of the pulmonary artery",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.010088977242620525,
            "u_vol": 0.0022,
            "el_base": 6000,
            "el_k": 0,
        },
        ...
        "AAR": {
            "name": "AAR",
            "description": "capacitance model of the aortic arch",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.006128775769877488,
            "u_vol": 0.003501795453394704,
            "el_base": 26250,
            "el_k": 0,
        },
        "AD": {
            "name": "AD",
            "description": "capacitance model of the descending aorta",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.022045886828499398,
            "u_vol": 0.019697599425345207,
            "el_base": 26250,
            "el_k": 0,
        },
        "RLB": {
            "name": "RLB",
            "description": "capacitance model of the blood compartment of the lower body",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0022221379384226463,
            "u_vol": 0.0010943110791858449,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "LS": {
            "name": "LS",
            "description": "capacitance model of the blood compartment of the liver and spleen",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.002213731699070824,
            "u_vol": 0.0010943110791858449,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "KID": {
            "name": "KID",
            "description": "capacitance model of the blood compartment of the kidneys",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0022137661552646677,
            "u_vol": 0.0010943110791858449,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "INT": {
            "name": "INT",
            "description": "capacitance model of the blood compartment of the intestines",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0022163662237057536,
            "u_vol": 0.0010943110791858449,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "RUB": {
            "name": "RUB",
            "description": "capacitance model of the blood compartment of the upper body",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0016677405369509085,
            "u_vol": 0.001149026633145137,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "BR": {
            "name": "BR",
            "description": "capacitance model of the blood compartment of the brain",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0023441127626145832,
            "u_vol": 0.001149026633145137,
            "el_base": 25024.77968970381,
            "el_k": 0,
        },
        "IVCI": {
            "name": "IVCI",
            "description": "capacitance model of the intrathoracic part of the inferior vena cava",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.025769092793056256,
            "u_vol": 0.0162,
            "el_base": 776.9196050775741,
            "el_k": 0,
        },
        "VLB": {
            "name": "VLB",
            "description": "capacitance model of the extrathoracic venous blood compartment of the lower body",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.08498446520517715,
            "u_vol": 0.083,
            "el_base": 145.42341325811003,
            "el_k": 0,
        },
        "SVC": {
            "name": "SVC",
            "description": "capacitance model of the superior vena cava",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.018772322344298622,
            "u_vol": 0.0108,
            "el_base": 1000,
            "el_k": 0,
        },
        "VUB": {
            "name": "VUB",
            "description": "capacitance model of the extrathoracic venous blood compartment of the upper body",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.04386921551382912,
            "u_vol": 0.0432,
            "el_base": 229.0916784203103,
            "el_k": 0,
        },
        "DA": {
            "name": "DA",
            "description": "capacitance model of the blood compartment in the ductus arteriosus",
            "model_type": "BloodCapacitance",
            "is_enabled": True,
            "vol": 0.0002,
            "u_vol": 0.0002,
        ...
        "ECLS_TUBIN": {
            "name": "ECLS_TUBIN",
            "model_type": "BloodCapacitance",
            "description": "capacitance model of the drainage tubing of ecls system",
            "is_enabled": False,
        ...
        "ECLS_PUMP": {
            ...
            "description": "blood pump model of the ecls system",
            "is_enabled": False,
            "fixed_composition": False,
            "vol": 0.8,
            "u_vol": 0.8,
            "el_base": 20000,
            "el_k": 0,
            "inlet": "ECLS_TUBIN_PUMP",
            "outlet": "ECLS_PUMP_OXY"
        },
        "ECLS_OXY": {
            "name": "ECLS_OXY",
            "model_type": "BloodCapacitance",
            "description": "capacitance model of the blood component of the oxygenator of ecls system",
            "is_enabled": False,
            "fixed_composition": False,
            "vol": 0.8,
            "u_vol": 0.8,
        ...
        "ECLS_TUBOUT": {
            "name": "ECLS_TUBOUT",
            "model_type": "BloodCapacitance",
            "description": "capacitance model of the blood in the tubing out of the ecls system",
            "is_enabled": False,
            "fixed_composition": False,
            "vol": 0.032,
            "u_vol": 0.032,
        ...
        "PLF": {
            "name": "PLF",
            "model_type": "BloodCapacitance",
            "description": "capacitance model of the blood on the fetal side of the placenta",
            "is_enabled": False,
            "fixed_composition": False,
            "u_vol": 0.15,
            "el_base": 25000,
        ...
        "PLM": {
            "name": "PLM",
            "model_type": "BloodCapacitance",
            "description": "capacitance model of the blood on the maternal side of the placenta",
            "is_enabled": False,
        ...
        "LA_LV": {
            "name": "LA_LV",
            "description": "blood valve model of the mitral valve",
            "model_type": "BloodValve",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
            "comp_from": "LA",
        ...
        "LV_AA": {
            "name": "LV_AA",
            "description": "blood valve model of the aortic valve",
            "model_type": "BloodValve",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "RA_RV": {
            "name": "RA_RV",
            "description": "blood valve model of the tricuspid valve",
            "model_type": "BloodValve",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "RV_PA": {
            "name": "RV_PA",
            "description": "blood valve model of the pulmonary valve",
            "model_type": "BloodValve",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "AA_AAR": {
            "name": "AA_AAR",
            "description": "resistor model of the connection between ascending aorta and aortic arch",
        ...
        "AA_COR": {
            "name": "AA_COR",
            "description": "resistor model of the connection between ascending aorta and the coronaries",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "COR_RA": {
            "name": "COR_RA",
            "description": "resistor model of the connection between the coronaries and the right atrium",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AAR_AD": {
            "name": "AAR_AD",
            "description": "resistor model of the connection between the aortic arch and the descending aorta",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_RLB": {
            "name": "AD_RLB",
            "description": "resistor model of the connection between descending aorta and the lower body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_LS": {
            "name": "AD_LS",
            "description": "resistor model of the connection between descending aorta and the liver and spleen",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_KID": {
            "name": "AD_KID",
            "description": "resistor model of the connection between descending aorta and the kidneys",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_INT": {
            "name": "AD_INT",
            "description": "resistor model of the connection between descending aorta and the intestines",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AA_RUB": {
            "name": "AA_RUB",
            "description": "resistor model of the connection between ascending aorta and the upper body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AA_BR": {
            "name": "AA_BR",
            "description": "resistor model of the connection between ascending aorta and the brain",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "RUB_VUB": {
            "name": "RUB_VUB",
            "description": "resistor model of the connection between upper body and the venous compartment of the upper body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "BR_VUB": {
            "name": "BR_VUB",
            "description": "resistor model of the connection between the brain and the venous compartment of the upper body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "RLB_VLB": {
            "name": "RLB_VLB",
            "description": "resistor model of the connection between lower body and the venous compartment of the lower body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "LS_VLB": {
            "name": "LS_VLB",
            "description": "resistor model of the connection between the liver and spleen and the venous compartment of the lower body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "KID_VLB": {
            "name": "KID_VLB",
            "description": "resistor model of the connection between the kidneys and the venous compartment of the lower body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "INT_VLB": {
            "name": "INT_VLB",
            "description": "resistor model of the connection between the intestines and the venous compartment of the lower body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "VLB_IVCI": {
            "name": "VLB_IVCI",
            "description": "resistor model of the connection between the venous compartment of the lower body and the inferior vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "IVCI_RA": {
            "name": "IVCI_RA",
            "description": "resistor model of the connection between the inferior vena cava and the right atrium",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "VUB_SVC": {
            "name": "VUB_SVC",
            "description": "resistor model of the connection between the venous compartment of the upper body and the superior vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "SVC_RA": {
            "name": "SVC_RA",
            "description": "resistor model of the connection between the superior vena cava and the right atrium",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "PA_LL": {
            "name": "PA_LL",
            "description": "resistor model of the connection between the pulmonary artery and the blood compartment of the left lung",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "PA_RL": {
            "name": "PA_RL",
            "description": "resistor model of the connection between the pulmonary artery and the blood compartment of the right lung",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "LL_PV": {
            "name": "LL_PV",
            "description": "resistor model of the connection between the blood compartment of the left lung and the pulmonary veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "RL_PV": {
            "name": "RL_PV",
            "description": "resistor model of the connection between the blood compartment of the right lung and the pulmonary veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "PV_LA": {
            "name": "PV_LA",
            "description": "resistor model of the connection between the pulmonary veins and the left atrium",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "DA_IN": {
            "name": "DA_IN",
            "description": "resistor model of the connection between the aortic arch and the ductus arteriosus",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "DA_OUT": {
            "name": "DA_OUT",
            "description": "resistor model of the connection between the ductus arteriosus and the pulmnonary artery",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "FO": {
            "name": "FO",
            "description": "resistor model of the foramen ovale",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": True,
            "no_back_flow": False,
        ...
        "VSD": {
            "name": "VSD",
            "description": "resistor model of a ventricular septal defect",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": True,
            "no_back_flow": False,
        ...
        "IPS": {
            "name": "IPS",
            "description": "resistor model of the intra-pulmonary shunt",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": True,
            "no_back_flow": False,
        ...
        "UMB_ART": {
            "name": "UMB_ART",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the descending aorta and the fetal placenta (umbilical arteries)",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "AD",
        ...
        "UMB_VEN": {
            "name": "UMB_VEN",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the fetal placenta and the inferior vena cava (umbilical vein)",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "PLF",
        ...
        "ECLS_DRAINAGE": {
            "name": "ECLS_DRAINAGE",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the right atrium and tubing of the ecls system (drainage cannula)",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "RA",
        ...
        "ECLS_TUBIN_PUMP": {
            "name": "ECLS_TUBIN_PUMP",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the tubing and the pump of the ecls system",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_TUBIN",
            "comp_to": "ECLS_PUMP",
            "r_for": 50,
            "r_back": 50,
            "r_k": 0
        ...
        "ECLS_PUMP_OXY": {
            "name": "ECLS_PUMP_OXY",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the pump and the oxygenator of the ecls system",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_PUMP",
        ...
        "ECLS_OXY_TUBOUT": {
            "name": "ECLS_OXY_TUBOUT",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the oxygenator and tubing of the ecls system",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_OXY",
        ...
        "ECLS_RETURN": {
            "name": "ECLS_RETURN",
            "model_type": "BloodResistor",
            "description": "resistor model of the connection between the tubing and the aortic arch of the ecls system (return cannula)",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_TUBOUT",
            "comp_to": "AAR",
            "r_for": 1700,
            "r_back": 1700,
            "r_k": 0,
        ...
        "PC": {
            ...
            "is_enabled": True,
            "contained_components": ["RA", "RV", "LA", "LV", "COR"],
            "vol": 0.019999912552092353,
            "u_vol": 0,
            "el_base": 9.960507757404796,
            "el_k": 1.0,
            "vol_extra": 0.0
        },
        "MOUTH": {
            ...
            "description": "capacitance model of the air at the mouth",
            "is_enabled": True,
            "fixed_composition": True,
            "vol":   1000000000,
            "u_vol": 1000000000,
        ...
        "DS": {
            "name": "DS",
            "model_type": "GasCapacitance",
            "description": "capacitance model of the dead space",
            "is_enabled": True,
            "fixed_composition": False,
            "vol": 0.00516,
            "u_vol": 0.0051,
        ...
        "ALR": {
            "name": "ALR",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the alveolar space of the right lung",
            "is_enabled": True,
            "fixed_composition": False,
            "vol": 0.07,
            "u_vol": 0.04,
        ...
        "MOUTH_DS": {
            ...
            "description": "gas resistor model of the connection between the mouth and dead space (airways)",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
            "comp_from": "MOUTH",
            "comp_to": "DS",
            "r_for": 18.61777150916784,
            "r_back": 18.61777150916784,
            "r_k": 0
        },
        "DS_ALL": {
            "name": "DS_ALL",
            "model_type": "GasResistor",
            "description": "gas resistor model of the connection between the dead space and the alveolar left lung",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
            "comp_from": "DS",
        ...
        "CHEST_L": {
            "name": "CHEST_L",
            "model_type": "Container",
            "description": "container model of the left chestwall",
            "is_enabled": True,
            "fixed_composition": False,
            "contained_components": ["ALL"],
            "vol": 0.07048329303030416,
            "u_vol": 0.053228712121212114,
            "el_base": 46.5444287729196,
            "el_k": 0,
            "vol_extra": 0.0
        },
        "CHEST_R": {
            "name": "CHEST_R",
            "model_type": "Container",
            "description": "container model of the right chestwall",
            "is_enabled": True,
            "fixed_composition": False,
            "contained_components": ["ALR"],
            "vol": 0.07048329303030416,
            "u_vol": 0.053228712121212114,
            "el_base": 46.5444287729196,
            "el_k": 0,
        ...
        "THORAX": {
            "name": "THORAX",
            "model_type": "Container",
            "description": "container model the thoracic rib cage",
            "is_enabled": True,
            "contained_components": ["CHEST_L", "CHEST_R", "IVCI", "SVC", "PC", "AA", "AAR", "PA", "PV", "LL", "RL"],
            "vol": 0.24722086254322656,
            "u_vol": 0.311530303030303,
            "el_base": 69.81664315937941,
            "el_k": 0.0,
            "vol_extra": 0.0
        },
        "BR_MAP": {
            "name": "BR_MAP",
            "model_type": "Afferent",
            "description": "ans baroreceptor afferent pathway",
            "is_enabled": True,
            "min_value": 25,
            "set_value": 50,
            "max_value": 100,
        ...
        "CR_PCO2": {
            "name": "CR_PCO2",
            "model_type": "Afferent",
            "description": "ans chemoreceptor pco2 afferent pathway",
            "is_enabled": True,
            "min_value": 15,
            "set_value": 40,
            "max_value": 75,
        ...
        "CR_PO2": {
            "name": "CR_PO2",
            "model_type": "Afferent",
            "description": "ans chemoreceptor po2 afferent pathway",
            "is_enabled": True,
            "min_value": 30,
            "set_value": 80,
            "max_value": 150,
        ...
        "CR_PH": {
            "name": "CR_PH",
            "model_type": "Afferent",
            "description": "ans chemoreceptor ph afferent pathway",
            "is_enabled": True,
            "min_value": 6.9,
            "set_value": 7.4,
            "max_value": 7.7,
        ...
        "EF_MV": {
            "name": "EF_MV",
            "model_type": "Efferent",
            "description": "ans effector pathway on minute volume",
            "is_enabled": True,
        ...
        "VENT_GASIN": {
            "name": "VENT_GASIN",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the gas reservoir of the mechanical ventilator",
            "is_enabled": False,
            "fixed_composition": True,
            "vol": 5.4,
            "u_vol": 5.0,
        ...
        "VENT_GASCIRCUIT": {
            "name": "VENT_GASCIRCUIT",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the gas volume inside the tubing of the mechanical ventilator",
            "is_enabled": False,
            "fixed_composition": False,
            "vol": 0.262,
            "u_vol": 0.262,
        ...
        "VENT_GASOUT": {
            "name": "VENT_GASOUT",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the return gas reservoir of the mechanical ventilator",
            "is_enabled": False,
            "fixed_composition": True,
            "vol": 5.0,
            "u_vol": 5.0,
        ...
        "ECLS_GASIN": {
            "name": "ECLS_GASIN",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the gas source of the ecls system",
            "is_enabled": False,
            "fixed_composition": True,
            "vol": 5.4,
            "u_vol": 5,
        ...
        "ECLS_GASOXY": {
            "name": "ECLS_GASOXY",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the gas inside the oxygenator of the ecls system",
            "is_enabled": False,
            "fixed_composition": False,
            "vol": 0.1,
            "u_vol": 0.1,
        ...
        "ECLS_GASOUT": {
            "name": "ECLS_GASOUT",
            "model_type": "GasCapacitance",
            "description": "gas capacitance model of the gas drainage compartment of the ecls system",
            "is_enabled": False,
            "fixed_composition": True,
            "vol": 5,
            "u_vol": 5,
        ...
        "VENT_INSP_VALVE": {
            "name": "VENT_INSP_VALVE",
            "model_type": "GasResistor",
            "description": "gas resistor model of the inspiratory valve of the mechanical ventilator",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "VENT_GASIN",
            "comp_to": "VENT_GASCIRCUIT",
            "r_for": 2000,
            "r_back": 2000,
            "r_k": 0
        },
        "VENT_ETTUBE": {
            "name": "VENT_ETTUBE",
            "model_type": "GasResistor",
            "description": "gas resistor model of the endotracheal tube",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
        ...
        "VENT_EXP_VALVE": {
            "name": "VENT_EXP_VALVE",
            "model_type": "GasResistor",
            "description": "gas resistor model of the expiratory valve of the mechanical ventilator",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": True,
            "comp_from": "VENT_GASCIRCUIT",
        ...
        "ECLS_GASIN_OXY": {
            "name": "ECLS_GASIN_OXY",
            "model_type": "GasResistor",
            "description": "gas resistor model of the connection between gas source and the oxygenator of the ecls system",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_GASIN",
            "comp_to": "ECLS_GASOXY",
            "r_for": 2000,
            "r_back": 2000,
            "r_k": 0,
        ...
        "ECLS_OXY_GASOUT": {
            "name": "ECLS_OXY_GASOUT",
            "model_type": "GasResistor",
            "description": "gas resistor model of the connection between oxygenator and the gas drainge component of the ecls system",
            "is_enabled": False,
            "no_flow": True,
            "no_back_flow": False,
            "comp_from": "ECLS_GASOXY",
            "comp_to": "ECLS_GASOUT",
            "r_for": 50,
            "r_back": 50,
            "r_k": 0
        ...
        "GASEX_RL": {
            "name": "GASEX_RL",
            "model_type": "GasExchanger",
            "description": "gas exchanger model of the blood-gas connection of the right lung",
            "is_enabled": True,
            "comp_blood": "RL",
            "comp_gas": "ALR",
            "dif_o2": 0.01,
        ...
        "ECLS_GASEX": {
            "name": "ECLS_GASEX",
            "model_type": "GasExchanger",
            "description": "gas exchanger model of gasexchange inside oxgenator of the ecls system",
            "is_enabled": False,
            "comp_blood": "ECLS_OXY",
            "comp_gas": "ECLS_GASOXY",
            "dif_o2": 0.001,
            "dif_co2": 0.001,
        },
        "PL_GASEX": {
        ...
        "Breathing": {
            ...
            "description": "spontanenous breathing model",
            "is_enabled": True,
        ...
        "Ans": {
            "name": "Ans",
            "model_type": "Ans",
            "description": "autonomic nervous system model",
            "is_enabled": True,
            "ans_active": True,
            "pathways": [
                {
        ...
        "Mob": {
            "name": "Mob",
            "model_type": "Mob",
            "description": "myocardial oxygen balance model",
            "is_enabled": True,
            "mob_active": True,
            "ecc_ref": 0.00000301,
            "pva_ref": 0.00143245,
        ...
        "Ecls": {
            ...
            "tubing_clamped": True,                              
            "drainage_cannula_diameter": 12,                     
            "drainage_cannula_length": 0.11,                
            "return_cannula_diameter": 10,                     
            "return_cannula_length": 0.11,                      
            "pump_volume": 0.8,
            "oxy_volume": 0.8,
            "oxy_resistance": 100,
            "oxy_dif_o2": 0.001,
        ...
        "Placenta": {
            ...
            "is_enabled": False,
            "umb_clamped": True,
            "umb_art_diameter": 0.005,
            "umb_art_length": 0.5,
            "umb_ven_diameter": 0.005,
            "umb_ven_length": 0.5,
            "umb_art_res" : 30000,
            "umb_ven_res" : 30000,
            "plf_u_vol" : 0.15,
        ...
        "Respiration": {
            ...
            "description": "respiration methods",
            "is_enabled": True,
    ...
    "model_groups": {
        ...
        "syst_veins": ["VLB", "VUB", "IVCI", "SVC"],
        "pulm_arteries": ["PA"],
        "pulm_veins": ["PV"],
        "syst_art_resistors": ["AA_AAR", "AA_RUB", "AA_BR", "AA_COR", "AAR_AD", "DA_IN", "AD_LS", "AD_INT", "AD_KID", "AD_RLB", "UMB_ART"],
        "syst_ven_resistors": ["LS_VLB", "KID_VLB", "INT_VLB", "RLB_VLB", "VLB_IVCI", "BR_VUB", "RUB_VUB", "VUB_SVC", "UMB_VEN"],
        "pulm_art_resistors": ["PA_LL", "PA_RL"],
        "pulm_ven_resistors": ["LL_PV", "RL_PV", "PV_LA"],
        "pulm_gasexchangers": ["GASEX_LL", "GASEX_RL"],
        "heart_atria": ["LA", "RA"],
        "heart_ventricles": ["LV", "RV"],
        "heart_valves": ["LA_LV", "RA_RV", "LV_AA", "RV_PA"],
        "coronaries": ["COR"],
        "pericardium": ["PC"],
        "cor_resistors": ["COR_RA"],
        "capillaries": ["LL", "RL", "INT", "KID", "LS", "RUB", "RLB", "BR"],
        "shunts": ["FO", "VSD", "IPS"],
        "thorax": ["THORAX"],
        "chestwall": ["CHEST_L", "CHEST_R"],
        "dead_space": ["DS"],
...
adult = {
    "name": "baseline_adult",
    "description": "non-pregnant female adult",
    "weight": 60.0,
    "height": 1.7,
    "modeling_stepsize": 0.0005,
    "model_time_total": 0.0,
    "models": {
        ...
        "PA_PV": {
            "name": "PA_PV",
            "description": "pulmonary artery to pulmonary veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AA_AD": {
            "name": "AA_AD",
            "description": "ascending aorta to descending aorta",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AA_UB": {
            "name": "AA_UB",
            "description": "ascending aorta to upper body",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_AR": {
            "name": "AD_AR",
            "description": "descending aorta to renal arteries",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AR_GL": {
            "name": "AR_GL",
            "description": "renal arteries to glomerulus",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "GL_TU": {
            "name": "GL_TU",
            "description": "glomerulus to tubule",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "GL_VR": {
            "name": "GL_VR",
            "description": "glomerulus to renal veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "TU_VR": {
            "name": "TU_VR",
            "description": "tubule to renal veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": True,
        ...
        "VR_VC": {
            "name": "VR_VC",
            "description": "renal veins to vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "AD_UA": {
            "name": "AD_UA",
            "description": "descending aorta to uterine arteries",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "UA_SA": {
            "name": "UA_SA",
            "description": "uterine arteries to spiral arteries",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "SA_UV": {
            "name": "SA_UV",
            "description": "spiral arteries to uterine veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "UA_UV": {
            "name": "UA_UV",
            "description": "uterine arteries to uterine veins",
            "model_type": "BloodResistor",
            "is_enabled": False,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "SA_PL": {
            "name": "SA_PL",
            "description": "spiral arteries to placenta",
            "model_type": "BloodResistor",
            "is_enabled": False,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "PL_UV": {
            "name": "PL_UV",
            "description": "placenta to uterine veins",
            "model_type": "BloodResistor",
            "is_enabled": False,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "UV_VC": {
            "name": "UV_VC",
            "description": "uterine veins to vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "UB_VC": {
            "name": "UB_VC",
            "description": "upper body to vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "LB_VC": {
            "name": "LB_VC",
            "description": "lower body to vena cava",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "VC_RA": {
            "name": "VC_RA",
            "description": "vena cava to right atrium",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "UmbA_PL_fetus": {
            "name": "UmbA_PL_fetus",
            "description": "umbilical arteries to placenta fetus",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "PL_fetus_UmbV":{
            "name": "PL_fetus_UmbV",
            "description": "placenta fetus to umbilical veins",
            "model_type": "BloodResistor",
            "is_enabled": True,
            "no_flow": False,
            "no_back_flow": False,
        ...
        "RenalAutoregulation": {
            ...
            "description": "Renal autoregulation: Myogenic response and tubuloglomerular feedback",
            "model_type": "RenalAutoregulation",
            "is_enabled": True,
            "delay_MR": 0.3,
            "delay_TGF":18,
            "delta1": 0.3,
...
normal_pregnant = {
    "name": "normal_pregnant",
    "description": "pregnant female adult",
    "weight": 60,
    "height": 1.70,
    "modeling_stepsize": 0.0005,
    "model_time_total": 0.0,
...
'''
# import the explain model engine and the baseline_term_neonate properties dictionary
from explain import ModelEngine, baseline_term_neonate

# initialize the model engine using the baseline_term_neonate model properties
